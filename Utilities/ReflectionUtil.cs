...
namespace CraftyCartsRemake.Utilities
{
    ...
    public static class ReflectionUtil
    {
        ...
        /// <summary>
        ///     Sets a field on the target object. <paramref name="targetType" /> specifies the <see cref="Type" /> the field
        ///     belongs to.
        /// </summary>
        ...
        ///     thrown when <paramref name="fieldName" /> is not a member of
        ///     <paramref name="obj" />
        /// </exception>
        /// <exception cref="ArgumentException">
        ///     thrown when <paramref name="obj" /> isn't assignable as
        ...
        /// <summary>
        ///     Sets a private field on the target object. <paramref name="targetType" /> specifies the <see cref="Type" /> the
        ///     field belongs to.
        /// </summary>
        /// <param name="obj">the object instance</param>
        /// <param name="fieldName">the field to set</param>
        ...
        {
            var prop = targetType.GetField(fieldName,
        ...
        /// <summary>
        ///     Gets the value of a private field. <paramref name="targetType" /> specifies the <see cref="Type" /> the field
        ///     belongs to.
        /// </summary>
        ...
        /// <summary>
        ///     Sets the value of a property on the target object. <paramref name="targetType" /> specifies the <see cref="Type" />
        ...
        /// <exception cref="InvalidOperationException">
        ///     thrown when <paramref name="propertyName" /> is not a member of
        ///     <paramref name="obj" />
        /// </exception>
        /// <exception cref="ArgumentException">
        ///     thrown when <paramref name="obj" /> isn't assignable as
        ...
        /// <summary>
        ///     Gets the value of a property. <paramref name="targetType" /> specifies the <see cref="Type" /> the field belongs
        ///     to.
        /// </summary>
        /// <param name="obj">the object instance to pull from</param>
        ...
        {
            return (T)InvokeMethod(obj, methodName, methodParams);
        }
        ...
        private static void CopyForType(Type type, Component source, Component destination)
        {
            ...
            foreach (FieldInfo fi in myObjectFields) fi.SetValue(destination, fi.GetValue(source));
        }
        ...
        {
            return GetField(obj, fieldName, obj.GetType());
        }
        ...
        {
            return (T)GetField(obj, fieldName, obj.GetType());
        }
